...
int main()
{
	...
	multimap<int, vector<vector<int>>> map_labels_to_images = MapLabelsToImages(vector_training_labels, vector_training_images);
	...
	map<int, double> map_label_priors = MapLabelPriors(vector_training_labels);
	string map_label_priors_file = "C:\\Users\\kongt\\naivebayes-TinaKong83\\MapLabelPriors.txt";
	WriteLabelPriorProbabilitiesToFile(map_label_priors, map_label_priors_file);
